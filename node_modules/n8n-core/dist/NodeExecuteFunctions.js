...
function isFilePathBlocked(filePath) {
    ...
    const userFolder = (0, UserSettings_1.getUserN8nFolderPath)();
    ...
    if (blockFileAccessToN8nFiles) {
        const restrictedPaths = [userFolder];
...
const getFileSystemHelperFunctions = (node) => ({
    ...
    getStoragePath() {
        return path_1.default.join((0, UserSettings_1.getUserN8nFolderPath)(), `storage/${node.type}`);
    },
