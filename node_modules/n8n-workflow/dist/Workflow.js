...
class Workflow {
    ...
    async runNode(executionData, runExecutionData, runIndex, additionalData, nodeExecuteFunctions, mode) {
        ...
        if (nodeType.executeSingle) {
            ...
            const context = nodeExecuteFunctions.getExecuteFunctions(this, runExecutionData, runIndex, connectionInputData, inputData, node, additionalData, executionData, mode);
